// Supabase Edge Function: create-reading (IMPROVED)
// - saves reading to DB
// - computes phase & five-elements
// - sends COMPELLING free preview email via Resend
// - includes upsell with better copy
...
function phaseFromMonth(month: number) {
  if (month === 1 || month === 2) return { id: "E", name: "Reflective", desc: "This phase favors insight over action. Trust your intuition.", emoji: "🌙" };
  if (month === 3 || month === 4) return { id: "D", name: "Transitional", desc: "A time of change and realignment. Stay flexible.", emoji: "🦋" };
  if (month === 5 || month === 6) return { id: "A", name: "Expanding", desc: "Energy is rising. This is your time to grow and reach.", emoji: "🌱" };
  if (month === 7 || month === 8) return { id: "B", name: "Stabilizing", desc: "Build foundations. Consistency brings rewards.", emoji: "⚓" };
  if (month === 9 || month === 10) return { id: "C", name: "Consolidating", desc: "Harvest what you've planted. Reflect on progress.", emoji: "🍂" };
  return { id: "E", name: "Reflective", desc: "This phase favors insight over action. Trust your intuition.", emoji: "🌙" };
}
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,#f8f6f3 0%,#f0ede8 100%);border-radius:12px;">
                <tr>
                  <td style="padding:30px;text-align:center;">
                    <p style="margin:0;font-size:40px;">${opts.phaseEmoji}</p>
                    <p style="margin:10px 0 5px;font-size:12px;text-transform:uppercase;letter-spacing:2px;color:#888;">Your Current Phase</p>
                  ...
                  <td style="padding:6px 0;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td>
                          <div style="height:8px;background:#eee;border-radius:99px;">
                            <div style="height:8px;width:${opts.elements.wood}%;background:#4a7c59;border-radius:99px;"></div>
                          </div>
                        </td>
                  ...
                  <td style="padding:6px 0;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td>
                          <div style="height:8px;background:#eee;border-radius:99px;">
                            <div style="height:8px;width:${opts.elements.fire}%;background:#c75146;border-radius:99px;"></div>
                          </div>
                        </td>
                  ...
                  <td style="padding:6px 0;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td>
                          <div style="height:8px;background:#eee;border-radius:99px;">
                            <div style="height:8px;width:${opts.elements.earth}%;background:#c9a227;border-radius:99px;"></div>
                          </div>
                        </td>
                  ...
                  <td style="padding:6px 0;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td>
                          <div style="height:8px;background:#eee;border-radius:99px;">
                            <div style="height:8px;width:${opts.elements.metal}%;background:#8d8d8d;border-radius:99px;"></div>
                          </div>
                        </td>
                  ...
                  <td style="padding:6px 0;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td>
                          <div style="height:8px;background:#eee;border-radius:99px;">
                            <div style="height:8px;width:${opts.elements.water}%;background:#4a6fa5;border-radius:99px;"></div>
                          </div>
                        </td>
          ...
          <tr>
            <td style="padding:30px 40px;text-align:center;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:20px;">
                ...
                <tr>
                  <td style="padding:6px 0;font-size:14px;color:#666;">❤️ Love & Relationships</td>
